...
const preferencesDefaults = {
    cloak: true,
    cloakUrl: 'https://schoology.svvsd.org',
    mask: true,
    maskTitle: 'Home',
    maskIconUrl: 'https://schoology.svvsd.org/sites/all/themes/schoology_theme/favicon.ico',
    background: true,
};
...
const presets = {
    schoology: {
        url: 'schoology.svvsd.org',
        title: 'Home | Schoology',
        icon: 'https://schoology.svvsd.org/sites/all/themes/schoology_theme/favicon.ico'
    },
    classroom: {
